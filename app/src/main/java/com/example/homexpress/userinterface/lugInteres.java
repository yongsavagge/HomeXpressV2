...
import com.example.homexpress.JsonParser;
...
public class lugInteres extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lug_interes);
        ...
        if (ActivityCompat.checkSelfPermission(lugInteres.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            getCurrentLocation();
        } else {
            ActivityCompat.requestPermissions(lugInteres.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, 44);
        }
